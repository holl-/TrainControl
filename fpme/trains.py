...
TRAINS = [
    Train('ICE', address=60, acceleration=40., speeds=(0, 0.1, 0.2, 11.8, 107.6, 145.3, 188.1, 208.8, 222.1, 235.6, 247.3, 258.3, 266.1, 274.5, 288)),
    ...
    Train('Dampf-Lok', address=78, acceleration=30., speeds=(0, 0.1, 0.2, 0.3, 33.3, 52.2, 70.3, 78.5, 106.3, 95.3, 97.9, 100.2, 102.5, 103.2, 106.3)),
